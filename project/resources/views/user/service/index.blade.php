                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td data-label="@lang('Property type')">
                                {{__($item->budget)}}{{ $currency->currency_symbol ?? ''}}
                              </td>
                              ...
                              <td data-label="@lang('Actions')">
                                <a target="__blank" href="{{ route('service.details',$item->id) }}" class="btn btn-sm btn-primary"><i
                                    class="fa fa-eye"></i></a>

                                    <a href="{{ route('service.edit',$item->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                    
                                    <a href="javascript:;" data-href="{{ route('user.service.delete',$item->id) }}" class="btn btn-sm btn-danger" data-toggle="modal"
