    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <span class="ipn-subtitle">Welcome To Investment Page</span>
                    ...
                    <div class="row">
                       ...
                       <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td data-label="@lang('Title')">{{$item->name}}</td>
                              <td data-label="@lang('Developer')">{{__($item->developer)}}</td>
                             
                              <td data-label="@lang('Building Name')">
                                {{ $item->building_name}}
                              </td>

                              <td data-label="@lang('Starting Price')">
                                {{ $item->starting_price}}{{ $currency->currency_symbol ?? ''}}
                              </td>
                              ...
                              <td data-label="@lang('Actions')">
                                <a target="__blank" href="{{ route('invest.details',$item->id) }}" class="btn btn-sm btn-primary"><i
                                    class="fa fa-eye"></i></a>
                       ...
                       @if ($investments->hasPages())
                        ...
                        {{$investments->links('admin.partials.paginate')}}
                        </div>
                        @endif
                    </div>
