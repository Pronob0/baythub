...
<div class="col-md-12">
    ...
    <div id="bed1-fields">
        <div class="row bed-field" id="bed1-1">
            @foreach ($bedsize->onebed as $size)
            ...
            @foreach ($bedprice->onebed as $price)
            <div class="form-group col-md-5">
...
<div class="col-md-12">
    ...
    <div id="bed2-fields">
        <div class="row bed-field" id="bed2-1">
            @foreach ($bedsize->twobed as $size)
            <div class="form-group col-md-5">
            ...
            @foreach ($bedprice->twobed as $price)
            <div class="form-group col-md-5">
...
<div class="col-md-12">
    ...
    <div id="bed2-fields">
        <div class="row bed-field" id="bed3-1">
            @foreach ($bedsize->threebed as $size)
            <div class="form-group col-md-5">
            ...
            @foreach ($bedprice->threebed as $price)
            <div class="form-group col-md-5">
...
<div class="col-md-12">
    ...
    <div id="bed2-fields">
        <div class="row bed-field" id="bed4-1">
            @foreach ($bedsize->fourbed as $size)
            <div class="form-group col-md-5">
            ...
            @foreach ($bedprice->fourbed as $price)
            <div class="form-group col-md-5">
...
<div class="col-md-12">
    ...
    <div id="bed2-fields">
        <div class="row bed-field" id="bed5-1">
            @foreach ($bedsize->fivebed as $size)
            <div class="form-group col-md-5">
            ...
            @foreach ($bedprice->fivebed as $price)
            <div class="form-group col-md-5">
...
<div class="col-md-12">
    ...
    <div id="bed2-fields">
        <div class="row bed-field" id="bed6-1">
            @foreach ($bedsize->sixbed as $size)
            <div class="form-group col-md-5">
            ...
            @foreach ($bedprice->sixbed as $price)
            <div class="form-group col-md-5">
...
<div class="col-md-12">
    ...
    <div id="bed2-fields">
        <div class="row bed-field" id="bed7-1">
            @foreach ($bedsize->sevenbed as $size)
            <div class="form-group col-md-5">
            ...
            @foreach ($bedprice->sevenbed as $price)
            <div class="form-group col-md-5">
