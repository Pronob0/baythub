               ...
               @forelse ($subcategories as $item)
                   <tr>
                        ...
                        <td data-label="@lang('Action')" class="text-right">
                            <a href="{{route('admin.attribute.index',$item->id)}}" class="btn btn-primary btn-sm mb-1"    title="@lang('Attribute')">@lang('Attribute')</a>

                           <a href="javascript:void()" class="btn btn-primary approve btn-sm edit mb-1" data-route="{{route('admin.subcategory.update',$item->id)}}" data-item="{{$item}}" data-toggle="tooltip" title="@lang('Edit')"><i class="fas fa-edit"></i></a>
...
@push('script')
    <script>
       ...
       $('.edit').on('click',function () { 
          ...
          $('#edit').find('select[name=category_id]').val(data.category_id)
