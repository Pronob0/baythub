   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form action="{{route('admin.service.update',$blog->id)}}" enctype="multipart/form-data" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="budget" value="{{$blog->budget}}" required placeholder="{{ __('Budget') }}">
                </div>

                <div class="form-group">
                    <label for="title">{{ __('Location') }}</label>
                    <input type="text" class="form-control" name="location" value="{{$blog->location}}" required placeholder="{{ __('Location') }}">
                </div>
