    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="" action="{{ route('admin.gs.mainupdate') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="maintenance" class="form-control" cols="10">{{ $gs->maintenance }}</textarea>
                        </div>
