        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="" action="{{route('admin.gs.update')}}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="form-group row mb-5">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control tagify__input"  id="tag" name="allowed_email" value="{{$gs->allowed_email}}">
                         <code>@lang('Keep this field blank if you want any email domain to be allowed.')</code>
                    </div>
                  </div>
                  ...
                  <div class="form-group row ">
                    <label for="secendary_color" class="col-sm-3 col-form-label">{{ __('User Registration (user )') }}</label>
                    <div class="col-sm-9">
                        <div class="btn-group mb-1">
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="tawk_id" name="copyright_text" value="{{$gs->copyright_text}}" placeholder="{{ __('Copyright Text') }}">
                    </div>
                    </div>
