        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-end">
                    <a href="{{ route('admin.subscription.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                        @lang('Add New')</a>
                </div>
                    ...
                    <table class="table align-items-center table-striped">
                        ...
                        @forelse ($plans as $item)
                            <tr>
                                ...
                                <td data-label="{{ __('contact limit') }}">
                                    {{ $item->contact_limit }}
                                </td>
                                ...
                                <td data-label="{{ __('Action') }}">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger  btn-sm remove mb-1"
                                        data-route="{{ route('admin.subscription.destroy',$item) }}" data-toggle="tooltip"
