        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-end">
                    <a href="{{ route('admin.gateway.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                        @lang('Add New')</a>
                </div>
                        ...
                        @forelse ($gateways as $item)
                            <tr>
                                ...
                                <td data-label="{{ __('Title') }}">
                                    {{ $item->name == null ? $item->title : $item->name }}
                                </td>
                                ...
                                <td data-label="{{ __('Action') }}">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger  btn-sm remove mb-1"
                                        data-route="{{ route('admin.gateway.destroy', $item->id) }}" data-toggle="tooltip"
