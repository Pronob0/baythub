            ...
            <table id="table" class="table table-striped">
               ...
               @forelse ($countries as $item)
                   <tr>
                        ...
                        <td data-label="@lang('Iso3')">
                          {{$item->iso3}}
                        </td>
                        <td data-label="@lang('Phone Code')">
                            {{$item->phone_code}}
                        </td>
                        ...
                        <td data-label="@lang('Action')" class="text-right">
                           <a href="{{ route('admin.state.index',$item->id) }}" class="btn btn-success btn-sm mb-1"   data-toggle="tooltip" title="@lang('Manage')">@lang('Manage')</a>

                           <a href="javascript:void()" class="btn btn-primary approve btn-sm edit mb-1" data-route="{{route('admin.country.update',$item->id)}}" data-item="{{$item}}" data-toggle="tooltip" title="@lang('Edit')"><i class="fas fa-edit"></i></a>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                ...
                <input class="form-control" type="text" name="iso3">
             </div>
             <div class="form-group">
    ...
    <script>
       ...
       $('.edit').on('click',function () { 
          ...
          $('#edit').find('input[name=name]').val(data.name)
            $('#edit').find('input[name=iso3]').val(data.iso3)
            $('#edit').find('input[name=phone_code]').val(data.phone_code)
